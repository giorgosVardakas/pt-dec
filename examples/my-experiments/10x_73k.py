...
class datasets_10x_73k(Dataset):
	def __init__(self, cuda, batch_size, testing_mode=False):
		self.ds, self.data_shape = get_10x_73k_dataset(batch_size)
		self.cuda = cuda
...
def main(cuda, batch_size, pretrain_epochs, finetune_epochs, testing_mode):
	...
	ds_train = datasets_10x_73k(cuda=cuda, batch_size=batch_size, testing_mode=testing_mode)  # training dataset
