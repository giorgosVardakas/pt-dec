...
def get_australian_dataset(batch_size=69):
...
def get_iris_dataset(batch_size=50):
...
def get_10x_73k_dataset(batch_size=64, data_points=-1):
...
def get_Pendigits_dataset(batch_size):
